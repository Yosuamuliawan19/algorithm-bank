...
def validMove(curBoard, x , player):
    ...
    if (x > 11) and (x%4 > 2)and (curBoard[x-5] == enemy) and (curBoard[x-10] == enemy) and (curBoard[x-15] == player):
        return True
    if (x > 7) and (x%4 < 1) and (curBoard[x-3] == enemy) and (curBoard[x-6] == player):
        return True
    if (x > 11) and (x%4 < 2)and (curBoard[x-3] == enemy) and (curBoard[x-6] == enemy) and (curBoard[x-9] == player):
        return True
    ...
    if (x < 4) and (x%4 > 2)and (curBoard[x+3] == enemy) and (curBoard[x+6] == enemy) and (curBoard[x+9] == player):
        return True
    if (x < 8) and (x%4 < 1) and (curBoard[x+5] == enemy) and (curBoard[x+10] == player):
        return True
    if (x < 4) and (x%4 < 2)and (curBoard[x+5] == enemy) and (curBoard[x+10] == enemy) and (curBoard[x-9] == player):
        return True
